...
public class lab6 {
	...
	System.out.println("Select the min number");
	myNumberL=input.nextInt();
	System.out.println("Select the max number");
	myNumberH=input.nextInt();
	
	RandomNumber myGame = new RandomNumber(myNumberL,myNumberH);//my class!!!!!!!!!!!!!!!!!!!
	
	
	
		 int genNumber=myGame.GetANumber();
		 System.out.printf("Is the number between %d-%d  odd(1) or even(2)?\n",myGame.GetLowNumber(),myGame.GetHighNumber());		 
